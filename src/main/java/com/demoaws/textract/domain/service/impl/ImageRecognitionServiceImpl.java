...
import com.demoaws.textract.domain.exception.RekognitionException;
...
public class ImageRecognitionServiceImpl implements ImageRecognitionService {
    ...
    @Override
    public RekognitionResponse recognizeImage(MultipartFile file) throws IOException {
        log.info("Recognizing celebrity from online");
